module.exports =
	onContextMenu: (event) ->
		...
		# console.log @selection.text.start.node
		# @d.innerHTML = @selection.text.start.node.parentElement.innerHTML
	...
	onMouseOver: (event) ->
		if @contextMenuOpen
			...
			# d2.innerHTML = @selection.text.start.node.parentElement.innerHTML
