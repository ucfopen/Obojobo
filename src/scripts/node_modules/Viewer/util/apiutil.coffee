...
APIUtil =
	...
	getAttempts: (lo) ->
		createParsedJsonPromise APIUtil.get "/api/assessments/attempts/user/4/draft/#{lo.get('_id')}"
	...
	endAttempt: (attempt) ->
		...
		createParsedJsonPromise APIUtil.post "/api/assessments/attempt/#{attempt.id}/end"
