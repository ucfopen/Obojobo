...
class TextGroupCommandHandler extends BaseCommandHandler
	...
	getCopyOfSelection: (selection, chunk) ->
		...
		if position is 'contains' or position is 'start' or position is 'end'
			...
			clone.componentContent.textGroup.deleteSpan sel.end.groupIndex, sel.end.offset, chunkEnd.groupIndex, chunkEnd.offset, true, @mergeTextGroups
			clone.componentContent.textGroup.deleteSpan chunkStart.groupIndex, chunkStart.offset, sel.start.groupIndex, sel.start.offset, true, @mergeTextGroups
	...
	styleSelection: (selection, chunk, styleType, styleData) ->
		...
		chunk.componentContent.textGroup.styleText sel.start.groupIndex, sel.start.offset, sel.end.groupIndex, sel.end.offset, styleType, styleData
	...
	_insertTextGroup: (selection, chunk, textGroup) ->
		...
		# alert 'splitText and onEnter must become a thing so that the splitText method on singleTexts doesnt mess this alg up'
