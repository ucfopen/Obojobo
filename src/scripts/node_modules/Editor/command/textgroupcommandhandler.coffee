...
class TextGroupCommandHandler extends BaseCommandHandler
	...
	deleteText: (selection, chunk, deleteForwards) ->
		...
		if deleteForwards and s.isTextEnd and not s.isLastGroup and tg.length > 1
	...
	absorb: (selection, consumerChunk, digestedChunk) ->
		...
		if not digestedTextGroup.isEmpty
			...
			console.log '------------'
			console.log '------------'
			console.log digestedTextGroup.isEmpty
	...
	split: (selection, chunk) ->
		...
		# console.log 'we started at the bottom but now we here'
		# console.log ttg.items
		# console.log mtg.items
		# console.log btg.items

		console.log 'AFTER DELETE SPAN'
		ttg.__debug_print()
		console.log '***'
		mtg.__debug_print()
		console.log '***'
		...
		# ttg.first.text.insertText 0, 'TOP_'
		# mtg.first.text.insertText 0, 'MID_'
		# btg.first.text.insertText 0, 'BOT_'
