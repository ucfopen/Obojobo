...
class ToggleCommandHandler extends BaseCommandHandler
	...
	getVirtualSelectionStartData: (selection, chunk, text, html) ->
		if chunk.isEditing()
			@textCommandHandler.getVirtualSelectionStartData.apply this, arguments
		else
			@focusCommandHandler.getVirtualSelectionStartData.apply this, arguments

	getVirtualSelectionEndData: (selection, chunk, text, html) ->
		if chunk.isEditing()
			@textCommandHandler.getVirtualSelectionEndData.apply this, arguments
		else
			@focusCommandHandler.getVirtualSelectionEndData.apply this, arguments

	getDOMSelectionStart: (selection, chunk, text, html) ->
		if chunk.isEditing()
			@textCommandHandler.getDOMSelectionStart.apply this, arguments
		else
			@focusCommandHandler.getDOMSelectionStart.apply this, arguments

	getDOMSelectionEnd: (selection, chunk, text, html) ->
		if chunk.isEditing()
			@textCommandHandler.getDOMSelectionEnd.apply this, arguments
		else
			@focusCommandHandler.getDOMSelectionEnd.apply this, arguments

	areCursorsEquivalent: (selection, chunk, text, html) ->
		if chunk.isEditing()
			@textCommandHandler.areCursorsEquivalent.apply this, arguments
		else
			@focusCommandHandler.areCursorsEquivalent.apply this, arguments
