...
MathEquation = React.createClass
	...
	render: ->
		...
		`<FocusableChunk className={'obojobo-draft--chunks--math-equation highlight-on-hover' + (this.state.editing ? '' : ' outline-on-selection')} onKeyDown={this.onAnchorKeyDown} onDoubleClick={this.edit} shouldPreventTab={this.props.shouldPreventTab}>
