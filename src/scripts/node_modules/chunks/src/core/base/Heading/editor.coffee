				...
				.addToolbarItem
					...
					onClick: (toolbarItem, editorState, selection) ->
						...
						if selection.virtual.type is 'caret'
							...
							newChunk.replaceSelection selection
