...
# oembed = require 'net/oembed' #@TODO #ObojoboDraft.net.OEmbed
# insertHtml = ObojoboDraft.page.insertHTML
...
# 	# 	console.log 'cwu'
# 	# 	console.log 'cwu'
# 	# 	console.log 'cwu', @props.chunk.componentContent.html, nextprops.chunk.componentContent.html

# 	# 	if @props.chunk.componentContent.html isnt nextprops.chunk.componentContent.html
# 	# 		console.log 'diff'
