...
textCommandHandler = new TextCommandHandler()
ImgCommandHandler = ObojoboDraft.command.FocusableCommandHandler
imgCommandHandler = new ImgCommandHandler()
...
Figure = React.createClass
	statics:
		...
		createNewNodeData: ->
			...
			url: 'http://lorempixel.com/1024/760/'
			size: 'small'
