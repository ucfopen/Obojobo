...
ToggleCommandHandler = Editor.command.ToggleCommandHandler
...
Table = React.createClass
	...
	updateControls: (event) ->
		...
		tgs = new TextGroupSelection @props.chunk, @props.selection
