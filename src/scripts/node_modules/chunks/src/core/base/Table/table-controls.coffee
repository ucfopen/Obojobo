...
insertButton = 'svg-url?noquotes!./assets/table-insert.svg'
...
TableControls = React.createClass
	...
	positionMenus: ->
		...
		[0...@props.chunk.componentContent.textGroup.numRows].map (index) ->
		...
		[0...@props.chunk.componentContent.textGroup.numCols].map (index) ->
	...
	render: ->
		...
		rows = [0...@props.chunk.componentContent.textGroup.numRows].map (index) ->
			`<TableMenu
		...
		cols = [0...@props.chunk.componentContent.textGroup.numCols].map (index) ->
			`<TableMenu
				onMenuCommand={onTableMenuCommand}
				type="col"
				col={index}
