...
module.exports = class CommandHandler extends TextGroupCommandHandler
	...
	onEnter: (selection, chunk, shiftKey) ->
		# alert 'break this up into onEnter and splitText'
		chunk.markDirty()
