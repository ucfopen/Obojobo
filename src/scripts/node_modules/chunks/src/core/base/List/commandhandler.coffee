...
module.exports = class CommandHandler extends TextGroupCommandHandler
	...
	deleteText: (selection, chunk, deleteForwards) ->
		...
		if not deleteForwards and not s.isFirstGroup and s.isTextStart and data.textGroup.get(s.groupIndex).data.indent > 0
			#...then unindent
