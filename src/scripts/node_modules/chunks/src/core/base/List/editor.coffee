		...
		register: ->
			...
			OBO.registerTextListener {
				match: (selection, editor) ->
					if selection.virtual.type is 'caret' and selection.startChunk.getComponent() is OBO.componentClassMap.defaultClass and selection.startChunk.componentContent.textGroup?.first?
