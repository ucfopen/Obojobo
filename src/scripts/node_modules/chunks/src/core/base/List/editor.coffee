...
List = React.createClass
	statics:
		...
		register: ->
			...
			OBO.addToolbarItem { type:'separator' }
			OBO.registerTextListener {
				match: (selection, editor) ->
					if selection.virtual.type is 'caret' and selection.startChunk.getComponent() is ComponentClassMap.getDefaultComponentClass() and selection.startChunk.componentContent.textGroup?.first?
