...
Image = React.createClass
	render: ->
		...
		if not data.url?
			imgStyles =
				backgroundImage: Common.util.getBackgroundImage require('svg-url?noquotes!./assets/bg.svg')
				backgroundSize: '16px'
				height: '300px'
		...
		switch data.size
			...
			when 'custom'
				...
				`<img src={data.url} unselectable="on" style={imgStyles} />`
			when 'large'
				imgStyles =
				...
				`<img unselectable="on" style={imgStyles} />`
