...
Blockquote = React.createClass
	...
	render: ->
		...
		`<TextChunk className="obojobo-draft--chunks--blockquote">
			<blockquote><TextGroupEl text={data.textGroup.first.text} groupIndex={data.textGroup.first.index} indent={data.textGroup.first.data.indent} /></blockquote>
			<cite><TextGroupEl text={data.textGroup.last.text} groupIndex={data.textGroup.last.index} indent={data.textGroup.last.data.indent} /></cite>
		</TextChunk>`
