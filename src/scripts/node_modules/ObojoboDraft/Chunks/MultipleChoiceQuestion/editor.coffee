...
Question = React.createClass
	...
	# 	# alert 'yo'
	# 	@props.chunkClipboard.store @props.chunk
	# 	el = document.createElement 'textarea'
	# 	# el.setAttribute 'type', 'text'
	# 	el.style.position = 'fixed'
	# 	el.style.top = '0'
	# 	el.style.left = '0'
	# 	el.textContent = 'id:' + @props.chunk.get('id')
	...
	renderPreview: ->
		...
		`<FocusableChunk
			className={'obojobo-draft--chunks--question preview' + (completelyCorrect ? ' correct' : '') + (incorrect ? ' incorrect' : '')}
			ref="component"
			onKeyDown={this.onAnchorKeyDown}
			onKeyUp={this.onAnchorKeyUp}
			onDoubleClick={this.startEditing}
		>
			<button className="edit-button" onClick={this.startEditing} style={editButtonStyles}>Edit</button>
