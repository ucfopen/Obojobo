	...
	renderEditor: ->
		...
		`<li className={'answer open' + (answer.data.score === 0 ? ' incorrect' : ' correct')}>
			<div className="label pad">
				...
				<div className="input" contentEditable="true" suppressContentEditableWarning={true} onFocus={this.props.onFocus} onBlur={this.props.onBlur} onKeyDown={this.onKeyDown}>
			...
			<div className="feedback" contentEditable="true" suppressContentEditableWarning={true} onFocus={this.props.onFocus} onBlur={this.props.onBlur} onKeyDown={this.onKeyDown}>
