	...
	renderEditor: ->
		...
		`<li className={'answer open' + (answer.data.score === 0 ? ' incorrect' : ' correct')}>
			<div className="label">
				...
				<div className="input" contentEditable="true" onFocus={this.props.onFocus} onBlur={this.props.onBlur}>
			...
			<div className="feedback" contentEditable="true" onFocus={this.props.onFocus} onBlur={this.props.onBlur}>
