...
class CommandHandler extends TextGroupCommandHandler
	...
	splitText: (selection, chunk, shiftKey) ->
		...
		sel = sel = new TextGroupSelection selection.chunk, chunk
	...
	indent: (selection, chunk, decreaseIndent) ->
		...
		# POS.reselectSpan selection.chunk, chunk, span
...
List = React.createClass
	...
	render: ->
		...
		window.yeOldListChunk = @state.chunk
	...
	renderEl: (node, index, indent) ->
		...
		switch node.nodeType
			when 'text'    then `<Text text={node.text} groupIndex={node.index} />`
