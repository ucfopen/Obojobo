...
MathEquation = React.createClass
	...
	render: ->
		...
		`<OboComponent model={this.props.model} moduleData={this.props.moduleData} className={'obojobo-draft--chunks--math-equation pad align-' + (this.props.model.modelState.align)}>
			<NonEditableChunk >
