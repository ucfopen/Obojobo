...
TextGroupSelection = require './textgroupselection'
...
class TextGroupCommandHandler extends BaseCommandHandler
	# constructor: (extendedMethods = {}) ->
	# 	for name, method of extendedMethods
	# 		@[name] = method
	...
	deleteSelection: (selection, chunk) ->
		...
		chunk.componentContent.textGroup.deleteSpan sel.start.groupIndex, sel.start.offset, sel.end.groupIndex, sel.end.offset, @mergeTextGroups
	...
	transformSelection: (selection, newChunk) ->
		console.log 'transformSelection', arguments
	...
	split: (selection, chunk) ->
		...
		console.log 'split'
		console.log sel.start.groupIndex, sel.end.groupIndex
		...
		middle.componentContent.textGroup.toSlice sel.start.groupIndex,   sel.end.groupIndex
