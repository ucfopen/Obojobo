...
TextGroupSelection.selectAll = (chunk, selection) ->
	selection.setFutureStart chunk, TextGroupSelection.startCursorOf(chunk).toObject()
	selection.setFutureEnd   chunk, TextGroupSelection.endCursorOf(chunk).toObject()

TextGroupSelection.selectText = (chunk, textIndex, selection) ->
	selection.setFutureStart chunk, TextGroupSelection.startCursorOfText(chunk.componentContent.textGroup.get(textIndex)).toObject()
	selection.setFutureEnd   chunk, TextGroupSelection.endCursorOfText(chunk.componentContent.textGroup.get(textIndex)).toObject()
