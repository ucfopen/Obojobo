...
class Chunk extends Backbone.Model
	...
	restoreSelection: (selection, type, savedSelData) -> @callComponentFn 'restoreSelection', selection, [type, savedSelData]
	saveDOMStateBeforeInput: (selection) -> @callComponentFn 'saveDOMStateBeforeInput', selection
