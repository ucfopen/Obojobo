...
class Chunk extends Backbone.Model
	...
	merge: (selection, digestedChunk, mergeText) ->
		@callComponentFn 'merge', selection, [digestedChunk, mergeText]
	...
	replaceSelection: (selection) ->
		@callComponentFn 'replaceSelection', selection
	...
	paste: (selection, text, html) ->
		@callComponentFn 'paste', selection, [text, html]
