...
Adapter =
	construct: (model, attrs) ->
		...
		if attrs?.content?.disableNavigationOnVisit?
			model.modelState.disableNavigationOnVisit = attrs.content.disableNavigationOnVisit
		else
			model.modelState.disableNavigationOnVisit = false

		if attrs?.content?.lockNavigationDuringTest?
			model.modelState.lockNavigationDuringTest = attrs.content.lockNavigationDuringTest
		else
			model.modelState.lockNavigationDuringTest = true
