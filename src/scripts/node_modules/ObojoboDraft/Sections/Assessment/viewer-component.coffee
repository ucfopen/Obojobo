...
module.exports = React.createClass
	...
	# 	console.clear()
	# 	console.log 'CWRP!', @props.model is nextProps.model
	# 	if @props.model isnt nextProps.model
	# 		@setState { assessment:AssessmentStore.getAssessment(nextProps.model) }
	...
	componentDidMount: ->
		...
		if step is 'untested' or step is 'takingTest'
			if @props.model.modelState.disableNavigationOnVisit
				Dispatcher.dispatch { type:'navDisable' }
	...
	startAssessment: ->
		# Dispatcher.dispatch { type:'navLock' }
		console.clear()
		console.log @props.model
		if @props.model.modelState.lockNavigationDuringTest
			Dispatcher.dispatch { type:'navLock' }
		...
		# @props.model.modelState.assessmentState.inTest = true
		# @setState { assessmentState:@props.model.modelState.assessmentState }
