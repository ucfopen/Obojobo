...
export default class TextGroupSelectionHandler extends BaseSelectionHandler {
	...
	getVirtualSelectionStartData(selection, chunk) {
		...
		if (((selection.dom != null ? selection.dom.startText : undefined) == null)) { return null; }
