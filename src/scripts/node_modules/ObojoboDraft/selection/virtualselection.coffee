...
class VirtualSelection
	...
	clone: ->
		virtSel = new VirtualSelection(@page)
	...
	fromObject: (o) ->
		@setStart @page.chunks.at(o.start.index), o.start.data
		@setEnd   @page.chunks.at(o.end.index), o.end.data
	...
	fromDOMSelection: (domSelection = null) ->
		...
		startChunk = @page.chunks.at startChunkIndex
		endChunk = @page.chunks.at endChunkIndex
...
VirtualSelection.fromObject = (page, o) ->
	vs = new VirtualSelection page
	vs.fromObject page, o

	vs

VirtualSelection.fromDOMSelection = (page, domSelection) ->
	vs = new VirtualSelection(page)
