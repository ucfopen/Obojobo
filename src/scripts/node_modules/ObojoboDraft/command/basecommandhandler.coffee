class BaseCommandHandler
	...
	getCopyOfSelection: (selection, chunk) -> false
	...
	merge: (selection, consumerChunk, digestedChunk) -> false
	...
	transformSelection: (selection, newChunk) -> false
	split: (selection, chunk) -> false
	saveSelection: (selection, chunk, position) -> null
	restoreSelection: (selection, chunk, type, savedSelData) -> false
	saveDOMStateBeforeInput: (selection, chunk) -> null
	...
	selectStart: (selection, chunk) -> false
	selectEnd: (selection, chunk) -> false
	selectAll: (selection, chunk) -> false
