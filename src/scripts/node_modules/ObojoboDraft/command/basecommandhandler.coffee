...
class BaseCommandHandler
	...
	getCopyOfSelection: (selection, chunk) -> chunk.clone true
	...
	replaceSelection: (selection, newChunk) ->
		...
		if selection.virtual.type isnt 'chunkSpan'
			...
			target.addChunkBefore newChunk
			...
			startChunk.addChunkBefore placeholderChunk
			...
			startChunk.addChunkBefore tmpChunk
	...
	areCursorsEquivalent: (selection, chunk, thisCursorData, otherCursorData) -> false
