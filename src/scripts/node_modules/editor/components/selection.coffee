...
class Selection
	...
	getSelectionDescriptor: ->
		...
		ChunkSelection.createDescriptor(
			...
			@chunk.start.chunk.saveSelection @, 'end'
		)
	...
	selectFromDescriptor: (module, descriptor) ->
		...
		# startGroupSel = new TextGroupSelection @chunk, @chunk.start.chunk
		# endGroupSel = new TextGroupSelection @chunk, @chunk.end.chunk

		# startTextEl = Text.getTextNode @chunk.start.chunk, startGroupSel.start.groupIndex
		# endTextEl = Text.getTextNode @chunk.end.chunk, endGroupSel.end.groupIndex

		# startTextEl.classList.add 'selection-text-start'
		# endTextEl.classList.add 'selection-text-end'
