...
EditorPage = React.createClass
	...
	getInitialState: ->
		...
		window.__force = @forcePageRerender
	...
	getInputActivityData: ->
		...
		chunk: chunk
		savedDOMState: chunk.getDOMStateBeforeInput @props.selection
	...
	onPaste: (event) ->
		...
		selType = @props.selection.chunk.type
		if selType is 'caret' or selType is 'textSpan'
			console.clear()
			console.log 'gonna paste'
			pasteSuccessful = @props.selection.startChunk.paste @props.selection, text, html
			console.log '-------'
			console.log '-------'
			console.log '-------'
			console.log '-------'
