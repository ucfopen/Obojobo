...
EditorApp = React.createClass
	...
	# componentDidUpdate: ->
	# 	console.log 'EEEEAAAACDU', @state.editingChunk
	# 	if @state.editingChunk? and not @disabledTab?
	# 		@disabledTab = true
	# 		@disableTab()

	# disableTab: ->
	# 	console.clear()
	# 	console.log 'TRAB', @state.module.chunks.models
	# 	for chunk in @state.module.chunks.models
	# 		console.log 'ccc', chunk
	# 		# if chunk isnt @state.editingChunk
	# 		# 	els = chunk.getDomNode().getElementsByTagName('*')
	# 		# 	console.log 'els', els
	# 		# 	for el in els
