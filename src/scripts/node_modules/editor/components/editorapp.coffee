...
EditorApp = React.createClass
	...
	getInitialState: ->
		...
		window.__tgs = ((index) ->
			new ObojoboDraft.textGroup.TextGroupSelection module.pages.at(@state.activePageIndex).chunks.at(index), @state.selection.virtual
		).bind(@)
