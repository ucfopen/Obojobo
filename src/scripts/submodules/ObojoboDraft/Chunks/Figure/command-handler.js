...
let _selectionInAnchor = function(selection, chunk) {
	...
	return ((tgs.start != null ? tgs.start.groupIndex : undefined) === 'anchor:main') || ((tgs.end != null ? tgs.end.groupIndex : undefined) === 'anchor:main');
};
...
export default (CommandHandler = class CommandHandler extends TextGroupCommandHandler {
	...
	getCaretEdge(selection, chunk) {
		if (_selectionInAnchor(selection, chunk)) { return 'start'; }
