...
import { moduleData, initModuleData, AssessmentStore, NavStore, QuestionStore, ScoreStore, ModalStore, FocusStore } from '../../../../__mocks__/viewer-state.mock'
				...
				children: [
					{
						...
						content: {
							textGroup: [
								{
									text: {
										value: 'You have {{assessment:attemptsRemaining}} attempts remaining out of {{assessment:attemptsAmount}}.'
									}
								}
							]
						}
