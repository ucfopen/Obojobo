...
jest.mock(
	...
	() => ({
		...
		logAndRespondToUnexpected: require.requireActual('../../server/util').logAndRespondToUnexpected
	}),
	{ virtual: false }
)
...
describe('start attempt route', () => {
   ...
   */
	...
	test('can retrieve question bank properties with attributes set', () => {
	...
	test('can retrieve question bank properties with NO attributes set', () => {
	...
	test('can initialize a map to track use of assessment questions', () => {
	...
	test('can track use of assessment questions using an initialized question map', () => {
	...
	test('can choose to display unseen question banks and questions sequentially', () => {
		const mockAssessmentProperties = {
	...
	test('can choose to display all question banks and questions randomly', () => {
	...
	test('can choose to display unseen question banks and questions randomly', () => {
