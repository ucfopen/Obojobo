...
describe('TextGroup', () => {
	...
	test('init builds the text group with items', () => {
		...
		tgWithItems.items.forEach(item => {
	...
	test('getStyles will return only the styles covered by the span', () => {
		...
		tgWith3Items.items[0].text.styleList.styles
		tgWith3Items.items[1].text.styleList.styles
		tgWith3Items.items[2].text.styleList.styles
