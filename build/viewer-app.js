...
module.exports = !__webpack_require__(14) && !__webpack_require__(36)(function () {
...
var _smoothscrollPolyfill = __webpack_require__(257);

var _smoothscrollPolyfill2 = _interopRequireDefault(_smoothscrollPolyfill);

var _isIterable = __webpack_require__(177);
...
if (!window.Set || !(0, _isIterable2.default)(new Set())) {
	window.Set = _set2.default;
}

// Array.from (IE)
if (!Array.from) {
	Array.from = _from2.default;
}
...
// Symbol (IE)
if (!window.Symbol) {
	window.Symbol = _symbol2.default;
}
