/******/ ;(function(modules) {
	...
	/******/ {
		...
		/***/ /***/ 33: function(module, exports, __webpack_require__) {
			...
			_Common2.default.Store.registerModel('ObojoboDraft.Chunks.MCInteraction', {
				type: 'chunk',
		...
		/***/ /***/ 64: function(module, exports, __webpack_require__) {
			...
			_Common2.default.Store.registerModel('ObojoboDraft.Chunks.MCInteraction.MCAnswer', {
				type: 'chunk',
				adapter: null,
				componentClass: _viewerComponent2.default,
				selectionHandler: new SelectionHandler()
						...
						value: function render() {
							...
							return React.createElement(
								OboComponent,
								{
									...
									moduleData: this.props.moduleData,
									className:
										'obojobo-draft--chunks--mc-interaction--mc-feedback' +
		...
		/***/ /***/ 66: function(module, exports, __webpack_require__) {
			...
			_Common2.default.Store.registerModel('ObojoboDraft.Chunks.MCInteraction.MCFeedback', {
				type: 'chunk',
				adapter: null,
				componentClass: _viewerComponent2.default,
				selectionHandler: new SelectionHandler()
		...
		/***/ /***/ 68: function(module, exports, __webpack_require__) {
			...
			var MCInteraction = (function(_React$Component) {
				_inherits(MCInteraction, _React$Component)

				function MCInteraction(props) {
					_classCallCheck(this, MCInteraction)

					var _this = _possibleConstructorReturn(
						this,
						(MCInteraction.__proto__ || Object.getPrototypeOf(MCInteraction)).call(this, props)
					)
						...
						value: function render() {
							...
							return React.createElement(
								OboComponent,
								{
									...
									tag: 'form',
									className:
										'obojobo-draft--chunks--mc-interaction' +
								...
								shuffledIds.map(function(id, index) {
									...
									if (child.get('type') !== 'ObojoboDraft.Chunks.MCInteraction.MCChoice') {
										return null
									}
				...
				return MCInteraction
			})(React.Component)

			exports.default = MCInteraction
		...
		/***/ /***/ 7: function(module, exports, __webpack_require__) {
			...
			_Common2.default.Store.registerModel('ObojoboDraft.Chunks.MCInteraction.MCChoice', {
				type: 'chunk',
				adapter: _adapter2.default,
				componentClass: _viewerComponent2.default,
				selectionHandler: new SelectionHandler()
					...
					[
						...
						},
						{
							...
							value: function createFeedbackItem(message) {
								var feedback = OboModel.create('ObojoboDraft.Chunks.MCInteraction.MCFeedback')
							...
							value: function render() {
								...
								return React.createElement(
									OboComponent,
									{
										...
										moduleData: this.props.moduleData,
										className:
											'obojobo-draft--chunks--mc-interaction--mc-choice' +
									...
									React.createElement(
										...
										this.props.model.children.map(function(child, index) {
											...
											var isAnswerItem = type === 'ObojoboDraft.Chunks.MCInteraction.MCAnswer'
											var isFeedbackItem = type === 'ObojoboDraft.Chunks.MCInteraction.MCFeedback'
