	...
	NavStore = function (superClass) {
	  ...
	  NavStore.prototype.generateNav = function (model, indent) {
	    ...
	    for (i = 0, len = ref.length; i < len; i++) {
	      ...
	      flatPath = '/view/' + model.getRoot().get('_id') + '/' + childNavItem.fullPath.join('/');
...
/***/ function(module, exports, __webpack_require__) {
	...
	hamburgerImg = __webpack_require__(237);

	arrowImg = __webpack_require__(236);

	lockImg = __webpack_require__(238);
