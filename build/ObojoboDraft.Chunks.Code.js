/******/ ;(function(modules) {
	...
	/******/ {
		...
		/***/ 30: /***/ function(module, exports, __webpack_require__) {
			...
			var _viewerComponent = __webpack_require__(53)
				...
				_createClass(Code, [
					{
						...
						value: function render() {
							...
							var texts = this.props.model.modelState.textGroup.items.map(function(
								textItem,
								index
							) {
							...
							return React.createElement(
								...
								React.createElement(
									...
									React.createElement('pre', null, React.createElement('code', null, texts))
								)
							)
						}
					}
