...
var AssessmentStore = function (_Store) {
	...
	_createClass(AssessmentStore, [{
		...
		value: function trySetResponse(questionId, response) {
			...
			return _apiUtil2.default.postEvent(model.getRoot(), 'assessment:setResponse', '3.1.0', {
	...
	function QuestionStore() {
		...
		Dispatcher.on({
			...
			'question:hide': function questionHide(payload) {
				_apiUtil2.default.postEvent(OboModel.models[payload.value.id].getRoot(), 'question:hide', '3.0.0', {
					questionId: payload.value.id
				});
...
var ViewerApp = function (_React$Component) {
	...
	_createClass(ViewerApp, [{
		...
		value: function onVisibilityChange(event) {
			...
			if (document.hidden) {
				_apiUtil2.default.postEvent(this.state.model, 'viewer:leave', '3.0.0', {}).then(function (res) {
		...
		value: function onIdle() {
			...
			_apiUtil2.default.postEvent(this.state.model, 'viewer:inactive', '3.0.0', {
