	...
	_createClass(ViewerApp, [{
		...
		value: function render() {
			...
			if (_navUtil2.default.canNavigate(this.state.navState)) {
				...
				if (nextModel) {
					if (nextModel.id == 'assessment') nextEl = _react2.default.createElement(_inlineNavButton2.default, { ref: 'next', type: 'next', title: 'Next: Assessment' });else nextEl = _react2.default.createElement(_inlineNavButton2.default, { ref: 'next', type: 'next', title: 'Next: ' + nextModel.title });
				} else {
