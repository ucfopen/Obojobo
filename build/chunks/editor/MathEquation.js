...
/***/ function(module, exports, __webpack_require__) {
	...
	var metricMap = __webpack_require__(122);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fontMetrics = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var buildTree = __webpack_require__(119);
	var parseTree = __webpack_require__(125);
	var utils = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FocusableSelectionHandler, MathEquation, NonEditableChunk, ObojoboDraft, getLatexHtml, katex, selectionHandler;

	__webpack_require__(106);

	katex = __webpack_require__(53);
	...
	getLatexHtml = function getLatexHtml(latex) {
	  var e, html;
	  try {
	...
	MathEquation = React.createClass({
	  ...
	  statics: {
	    ...
	    register: function register() {
	      return OBO.registerChunk(MathEquation, {
	  ...
	  getInitialState: function getInitialState() {
	    var katexHtml;
	    katexHtml = getLatexHtml(this.props.chunk.componentContent.latex);
	  ...
	  render: function render() {
	    console.log('RENDER', this.props.chunk.componentContent.latex, this.state.katexHtml);
	    if (this.state.katexHtml.length === 0) {
	      return null;
	    }
	    return React.createElement(
	      NonEditableChunk,
	      { className: 'obojobo-draft--chunks--math-equation pad' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var matchAt = __webpack_require__(126);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var environments = __webpack_require__(121);
	var Lexer = __webpack_require__(114);
	var symbols = __webpack_require__(15);
	var utils = __webpack_require__(1);

	var parseData = __webpack_require__(43);
	var ParseError = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var buildCommon = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var buildCommon = __webpack_require__(14);
	var fontMetrics = __webpack_require__(8);
	var mathMLTree = __webpack_require__(124);
	var ParseError = __webpack_require__(2);
	var symbols = __webpack_require__(15);
	var utils = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var buildHTML = __webpack_require__(117);
	var buildMathML = __webpack_require__(118);
	var buildCommon = __webpack_require__(14);
	var Options = __webpack_require__(115);
	var Settings = __webpack_require__(41);
	var Style = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DeleteButton, EditButton, Editor, FocusableChunk, FocusableCommandHandler, FocusableSelectionHandler, MathEquation, OBO, ObojoboDraft, SingleInputBubble, Viewer, commandHandler, getLatexHtml, katex, selectionHandler;

	__webpack_require__(216);

	Viewer = __webpack_require__(88);
	...
	MathEquation = React.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    var latex, result;
	    latex = this.props.chunk.componentContent.latex;
	  ...
	  onCancel: function onCancel() {
	    return this.stopEditing(this.state.editing.initialLatex);
	  },
	  onClose: function onClose() {
	    return this.stopEditing(this.state.editing.lastValidLatex);
	  },
	  stopEditing: function stopEditing(finalLatex) {
	    var data;
	  ...
	  render: function render() {
	    var chunk, data, hasError, isEditing, isEmpty, ref;
	    chunk = this.props.chunk;
	    data = chunk.componentContent;
	    hasError = ((ref = this.state.editing) != null ? ref.katexError : void 0) != null;
	    isEmpty = data.latex === '';
	    isEditing = this.props.isEditing;
	    return React.createElement(
	      FocusableChunk,
	      { className: 'obojobo-draft--chunks--math-equation' + (this.state.editing ? '' : ' outline-on-selection highlight-on-hover'), onKeyDown: this.onAnchorKeyDown, onDoubleClick: this.edit, shouldPreventTab: this.props.shouldPreventTab },
	      React.createElement(
	        'div',
	        { className: (hasError ? ' error' : '') + (isEmpty ? ' empty' : '') },
	        hasError && isEditing ? React.createElement(
	          'span',
	          { className: 'error-msg' },
	          this.state.editing.katexError
	        ) : null,
	        isEmpty ? React.createElement(
	          ...
	          React.createElement(
	            ...
	            '(',
	            isEditing ? 'Type an equation...' : 'Click edit to create a Latex equation',
	            ')'
	          )
	        ) : React.createElement('div', { className: 'katex-container', dangerouslySetInnerHTML: { __html: this.state.katexHtml } }),
	        isEditing ? React.createElement(SingleInputBubble, { label: 'Edit latex equation', value: data.latex, onChange: this.onChange, onClose: this.onClose, onCancel: this.onCancel }) : React.createElement(EditButton, { onClick: this.edit, shouldPreventTab: this.props.shouldPreventTab }),
	        isEditing ? null : React.createElement(DeleteButton, { onClick: this.onDeleteButtonClick, shouldPreventTab: this.props.shouldPreventTab })
	      )
	    );
	  }
	});
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/svg+xml;charset=utf8,%3Csvg id='Layer_1' data-name='Layer 1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20.29 14.79'%3E%3Cdefs%3E%3Cstyle%3E.cls-1%7Bopacity:0.55;font-size:13px;font-family:Times New Roman;font-style:italic;%7D%3C/style%3E%3C/defs%3E%3Ctitle%3Eequation%3C/title%3E%3Ctext class='cls-1' transform='translate(2.25 10.8)'%3Ef(x)%3C/text%3E%3C/svg%3E"
