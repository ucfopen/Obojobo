/******/ ;(function(modules) {
	...
	/******/ {
		...
		/***/ /***/ 41: function(module, exports, __webpack_require__) {
			...
			var _viewerComponent = __webpack_require__(79)
				...
				_createClass(QuestionContent, [
					{
						...
						value: function render() {
							...
							return React.createElement(
								...
								this.props.model.children.models
									.slice(0, this.props.model.children.models.length - 1)
				...
				_createClass(Question, [
					...
					},
					{
						...
						value: function render() {
							...
							var assessment = this.props.model.children.models[
								this.props.model.children.models.length - 1
							]
							...
							return React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement(_viewerComponent2.default, {
											model: this.props.model,
											moduleData: this.props.moduleData
										}),
