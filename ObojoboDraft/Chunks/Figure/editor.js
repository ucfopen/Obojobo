...
class Node extends React.Component {
	...
	handleAltChange() {
		const newAltText = window.prompt('Enter the new alt text:', this.state.alt) || this.state.alt
	...
	handleURLChange() {
		const newURL = window.prompt('Enter the new URL:', this.state.url) || this.state.url
			...
			<div className={'component'} {...this.props.attributes}>
				<div className={`obojobo-draft--chunks--figure viewer ` + this.state.size}>
					...
					<div className={'container'}>
						{isCustom ? (
							<img src={this.state.url} unselectable="on" alt={this.state.alt} style={imgStyles} />
						) : (
							<img src={this.state.url} unselectable="on" alt={this.state.alt} />
						)}
