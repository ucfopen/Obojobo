...
export default class MCChoice extends React.Component {
	...
	createFeedbackItem(message) {
		let feedback = OboModel.create('ObojoboDraft.Chunks.MCInteraction.MCFeedback')
			...
			>
				...
				<div className="children">
					{this.props.model.children.map((child, index) => {
						...
						let isAnswerItem = type === 'ObojoboDraft.Chunks.MCInteraction.MCAnswer'
						let isFeedbackItem = type === 'ObojoboDraft.Chunks.MCInteraction.MCFeedback'
