...
exports.up = function(db) {
  return db.createTable('users_auth_identities', {
  ...
  .then( result => {
    return db.addIndex('users_auth_identities', 'uai_unique_identity', ['auth_provider', 'auth_provider_user_id'], true)
  })
  .then( result => {
    return db.addIndex('users_auth_identities', 'uai_auth_provider_user_id', ['auth_provider_user_id'])
  })
  .then( result => {
