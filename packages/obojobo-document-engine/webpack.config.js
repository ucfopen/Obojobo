...
var mainConfig = {
	entry: {
		...
		'ObojoboDraft.Chunks.SheetMusic': [
			path.join(__dirname, 'ObojoboDraft', 'Chunks', 'SheetMusic', 'viewer.js')
		],
		'ObojoboDraft.Chunks.Audio': [
			path.join(__dirname, 'ObojoboDraft', 'Chunks', 'Audio', 'viewer.js')
		],
		'ObojoboDraft.Chunks.Passage': [
			path.join(__dirname, 'ObojoboDraft', 'Chunks', 'Passage', 'viewer.js')
		],
