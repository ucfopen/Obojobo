...
const ReviewIcon = () => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 114.33 114.33">
			...
			<rect className="cls-2" x="32.5" y="28.87" width="49.33" height="56.6" rx="3.72" ry="3.72" />
			<path
				className="cls-3"
			...
			/>
			<rect className="cls-3" x="51.5" y="41.29" width="23.75" height="4.25" rx="2.12" ry="2.12" />
			<path
				className="cls-3"
			...
			/>
			<rect className="cls-3" x="51.5" y="55.04" width="23.75" height="4.25" rx="2.12" ry="2.12" />
			<path
				className="cls-3"
				d="M43.15,66.85a4.06,4.06,0,1,0,4.06,4.06A4.06,4.06,0,0,0,43.15,66.85Z"
			/>
			<rect className="cls-3" x="51.5" y="68.79" width="23.75" height="4.25" rx="2.12" ry="2.12" />
			<path
				className="cls-2"
			...
			/>
			<circle className="cls-5" cx="72.16" cy="70.2" r="8.79" />
			<path
				className="cls-6"
