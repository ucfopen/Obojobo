...
const Icon = () => {
	return (
		<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16.09 12.79">
			<defs>
				<style>{`.cls-1{opacity:0.55;}.cls-2{fill:#231f20;}.cls-3{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;}`}</style>
			</defs>
