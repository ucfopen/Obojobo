...
describe('ViewerApp', () => {
	...
	test('ViewerApp displays error message on error generated by child component', () => {
		mocksForMount()

		jest.spyOn(global.console, 'log')

		const component = mount(<ViewerApp />)
		component.instance().componentDidCatch('Something went wrong', 'ChildComponent')
		component.update()

		expect(component.instance().state.hasError).toBeTruthy()
		expect(global.console.log).toHaveBeenCalledWith('Something went wrong')
		expect(global.console.log).toHaveBeenCalledWith('ChildComponent')
	})
