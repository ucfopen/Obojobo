...
describe('Clipboard Util', () => {
	...
	test('setPoint returns with no selection', () => {
		const editor = {
			selection: null
		}
	...
	test('setPoint changes anchor', () => {
		jest.spyOn(Transforms, 'setSelection').mockReturnValue(true)
		...
		Transforms.setPoint(editor, { path: [0], offset: 3 }, { edge: 'anchor' })
	...
	test('setPoint changes start', () => {
		...
		Transforms.setPoint(editor, { path: [0], offset: 3 }, { edge: 'start' })
		expect(editor.selection).toMatchInlineSnapshot(`
		Object {
		  "anchor": Object {
		    "offset": 1,
	...
	test('setPoint changes end', () => {
		...
		Transforms.setPoint(editor, { path: [0], offset: 3 }, { edge: 'end' })
		expect(editor.selection).toMatchInlineSnapshot(`
		Object {
		  "anchor": Object {
		    "offset": 1,
	...
	test('setPoint changes start backwards', () => {
		jest.spyOn(Transforms, 'setSelection').mockReturnValue(true)
	...
	test('setPoint changes end backwards', () => {
		jest.spyOn(Transforms, 'setSelection').mockReturnValue(true)
