...
jest.mock('./styleable-text-renderer')

import StyleableText from './styleable-text-component'
import StyleRenderer from './styleable-text-renderer'
...
describe('StyleableText Component', () => {
	...
	test('StyleableText with role', () => {
		StyleRenderer.mockReturnValueOnce({
			type: 'span',
			children: [],
			attrs: { role: 'mock-role-text' }
		})
	...
	test('StyleableText with alt and role', () => {
		StyleRenderer.mockReturnValueOnce({
			type: 'span',
			children: [],
			attrs: { alt: 'mock-alt-text', role: 'mock-role-text' }
		})
