...
import EditorUtil from '../../oboeditor/util/editor-util'
jest.mock('../../oboeditor/util/editor-util')
jest.mock('../../viewer/util/viewer-api')
...
const EditorStore = require('./editor-store').default
