jest.mock('./visual-editor')
jest.mock('./code-editor')
jest.mock('../../viewer/util/editor-api')
jest.mock('../stores/editor-store')
jest.mock('../../common/stores/modal-store')
jest.mock('../../common/util/modal-util')
jest.mock('../../common/models/obo-model')
jest.mock('../util/editor-util')
...
describe('EditorApp', () => {
	...
	beforeEach(() => {
		...
		EditorUtil = require('../util/editor-util').default
		EditorAPI = require('../../viewer/util/editor-api').default
		EditorStore = require('../stores/editor-store').default
		ModalStore = require('../../common/stores/modal-store').default
		ModalUtil = require('../../common/util/modal-util').default
		Common = require('../../common').default
		EditorApp = require('./editor-app').default
