...
import MoreInfoBox from '../../components/navigation/more-info-box'
...
jest.mock('../../util/is-valid-id')
jest.mock('../../components/navigation/more-info-box', () =>
	global.mockReactComponent(this, 'MockMoreInfoBox')
)
jest.mock('./components/insert-menu', () => global.mockReactComponent(this, 'MockInsertMenu'))
jest.mock('slate')
...
describe('Component Editor Node', () => {
	...
	test('Node builds the expected component when selected when parent is a question node with solution child', () => {
		// mock parts needed to display MoreInfoBox
