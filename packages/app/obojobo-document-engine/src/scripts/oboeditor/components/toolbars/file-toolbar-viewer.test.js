...
import FileToolbarViewer from './file-toolbar-viewer'
...
jest.mock('./file-menu')
jest.mock('./view-menu')
jest.mock('../../../common/registry')
jest.mock('./drop-down-menu', () => global.mockReactComponent(this, 'DropDownMenu'))
jest.mock('./file-toolbar', () => global.mockReactComponent(this, 'FileToolbar'))
jest.mock('./format-menu', () => global.mockReactComponent(this, 'FormatMenu'))
