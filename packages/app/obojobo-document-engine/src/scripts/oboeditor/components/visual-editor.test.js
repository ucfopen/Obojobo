...
jest.mock('./navigation/editor-nav')
jest.mock('./toolbars/paragraph-styles')
jest.mock('./toolbars/file-toolbar-viewer', () => props => (
	<div {...props} className={'mockFileToolbarViewer'} />
))
jest.mock('./hovering-preview', () => props => <div {...props} className={'mockHoveringPreview'} />)
