...
// This may have to change to handle multiple users in addition to multiple modules, it's unclear
// There will also have to be a bulk equivalent for removing permissions
const BULK_ADD_USER_TO_MODULES = 'BULK_ADD_USER_TO_MODULES'
const bulkAddUserToModules = null
// const bulkAddUserToModules = (draftIds, userId) => ({
// 	type: BULK_ADD_USER_TO_MODULES,
// 	promise: Promise.all(draftIds.map(draftId => apiAddPermissionsToModule(draftId, userId)))
// })
