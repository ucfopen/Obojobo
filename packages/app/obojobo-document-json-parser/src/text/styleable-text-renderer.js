...
const StyleType = require('../../common/text/style-type')
const MockElement = require('../../common/mockdom/mock-element')
const MockTextNode = require('../../common/mockdom/mock-text-node')
