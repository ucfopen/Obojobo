!(function(e) {
			...
			;(a = function() {
				...
				function L(e, t) {
					...
					if (
						...
						for (n = 0; n < M.length; n++) d((r = t[(o = M[n])])) || (e[o] = r)
					return e
				}
				var Y = !1
				function b(e) {
				...
				function D(e, t, n) {
					var o,
						...
						s = 0
					for (o = 0; o < r; o++) ((n && e[o] !== t[o]) || (!n && v(e[o]) !== v(t[o]))) && s++
					return s + a
				}
				function T(e) {
				...
				var w,
					j = {}
				function H(e, t) {
					null != r.deprecationHandler && r.deprecationHandler(e, t), j[e] || (T(t), (j[e] = !0))
				}
				function x(e) {
				...
				function F(e) {
					var t,
						n,
						o = {}
					for (n in e) l(e, n) && (t = A(n)) && (o[t] = e[n])
					return o
				}
				var C = {}
				function z(e, t) {
				...
				function $(e, t) {
					...
					for (R.lastIndex = 0; n >= 0 && R.test(e); )
						(e = e.replace(R, o)), (R.lastIndex = 0), (n -= 1)
					return e
				}
				var q = /\d/,
					K = /\d\d/,
				...
				G('Y', 0, 0, function() {
					...
					fe('YYYY', function(e, t) {
						t[Me] = 2 === e.length ? r.parseTwoDigitYear(e) : v(e)
					}),
					fe('YY', function(e, t) {
				...
				function xe(e, t) {
					return function(n) {
						return null != n ? (Pe(this, e, n), r.updateOffset(this, t), this) : Oe(this, e)
					}
				}
				function Oe(e, t) {
				...
				function Ee(e, t) {
					...
					var n,
						o = ((t % (n = 12)) + n) % n
					return (e += (t - o) / 12), 1 === o ? (we(e) ? 29 : 28) : 31 - ((o % 7) % 2)
				}
				;(je = Array.prototype.indexOf
					...
					fe(['MMM', 'MMMM'], function(e, t, n, o) {
						var r = n._locale.monthsParse(e, o, n._strict)
						null != r ? (t[Le] = r) : (f(n).invalidMonth = e)
					})
				var We = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
				...
				function Ce(e, t, n) {
					...
					return n
						? 'MMM' === t
							? -1 !== (r = je.call(this._shortMonthsParse, s))
								? r
								: null
							: -1 !== (r = je.call(this._longMonthsParse, s))
							? r
							: null
						: 'MMM' === t
						? -1 !== (r = je.call(this._shortMonthsParse, s))
				...
				function Ne(e) {
					return null != e ? (ze(this, e), r.updateOffset(this, !0), this) : Oe(this, 'Month')
				}
				var Je = ue,
					Re = ue
				function Ie() {
				...
				function Ue(e, t, n, o, r, a, s) {
					var i
					return (
						e < 100 && e >= 0
							? ((i = new Date(e + 400, t, n, o, r, a, s)),
							  isFinite(i.getFullYear()) && i.setFullYear(e))
							: (i = new Date(e, t, n, o, r, a, s)),
						i
					)
				}
				function Ge(e) {
				...
				function Ve(e, t, n) {
					var o = 7 + t - n
					return (-(7 + Ge(e, 0, o).getUTCDay() - t) % 7) + o - 1
				}
				function $e(e, t, n, o, r) {
					var a,
						s,
						i = 1 + 7 * (t - 1) + ((7 + n - o) % 7) + Ve(e, o, r)
					return (
						i <= 0
							? (s = ge((a = e - 1)) + i)
							: i > ge(e)
				...
				function qe(e, t, n) {
					...
					return (
						s < 1
							? (o = s + Ke((r = e.year() - 1), t, n))
							: s > Ke(e.year(), t, n)
							? ((o = s - Ke(e.year(), t, n)), (r = e.year() + 1))
							: ((r = e.year()), (o = s)),
						{ week: o, year: r }
					)
				}
				...
				function et(e, t, n) {
					...
					return n
						? 'dddd' === t
							? -1 !== (r = je.call(this._weekdaysParse, s))
								? r
								: null
							: 'ddd' === t
							? -1 !== (r = je.call(this._shortWeekdaysParse, s))
								? r
								: null
							: -1 !== (r = je.call(this._minWeekdaysParse, s))
							? r
							: null
						: 'dddd' === t
						? -1 !== (r = je.call(this._weekdaysParse, s))
				...
				function rt() {
					...
					for (t = 0; t < 7; t++)
						(n = y([2e3, 1]).day(t)),
							...
							u.push(r),
							u.push(a)
					for (s.sort(e), i.sort(e), d.sort(e), u.sort(e), t = 0; t < 7; t++)
						(i[t] = ce(i[t])), (d[t] = ce(d[t])), (u[t] = ce(u[t]))
				...
				G('H', ['HH', 2], 0, 'hour'),
					...
					G('hmm', 0, 0, function() {
						return '' + at.apply(this) + N(this.minutes(), 2)
					}),
					G('hmmss', 0, 0, function() {
						return '' + at.apply(this) + N(this.minutes(), 2) + N(this.seconds(), 2)
					}),
					G('Hmm', 0, 0, function() {
					...
					fe('hmm', function(e, t, n) {
						var o = e.length - 2
						;(t[be] = v(e.substr(0, o))), (t[ke] = v(e.substr(o))), (f(n).bigHour = !0)
					}),
					...
					fe('Hmm', function(e, t, n) {
						var o = e.length - 2
						;(t[be] = v(e.substr(0, o))), (t[ke] = v(e.substr(o)))
					}),
					fe('Hmmss', function(e, t, n) {
						var o = e.length - 4,
							r = e.length - 2
						;(t[be] = v(e.substr(0, o))), (t[ke] = v(e.substr(o, 2))), (t[Se] = v(e.substr(r)))
					})
				var dt,
					ut = xe('Hours', !0),
					_t = {
				...
				function yt(t) {
					var o = null
					if (!mt[t] && void 0 !== e && e && e.exports)
						try {
							;(o = dt._abbr), n(592)('./' + t), ft(o)
						} catch (e) {}
					return mt[t]
				}
				function ft(e, t) {
				...
				function pt(e, t) {
					if (null !== t) {
						...
						if (((t.abbr = e), null != mt[e]))
							...
							if (null != mt[t.parentLocale]) o = mt[t.parentLocale]._config
							else {
								if (null == (n = yt(t.parentLocale)))
									return (
				...
				function ht(e) {
					...
					return (function(e) {
						for (var t, n, o, r, a = 0; a < e.length; ) {
							for (
								t = (r = ct(e[a]).split('-')).length, n = (n = ct(e[a + 1])) ? n.split('-') : null;
								t > 0;

							) {
								if ((o = yt(r.slice(0, t).join('-')))) return o
					...
					return (
						n &&
							...
							((t =
								n[Le] < 0 || n[Le] > 11
									? Le
									: n[Ye] < 1 || n[Ye] > Ee(n[Me], n[Le])
									? Ye
									: n[be] < 0 ||
									  n[be] > 24 ||
									  (24 === n[be] && (0 !== n[ke] || 0 !== n[Se] || 0 !== n[ve]))
									? be
									: n[ke] < 0 || n[ke] > 59
									? ke
									: n[Se] < 0 || n[Se] > 59
				...
				function Yt(e) {
					...
					if (!e._d) {
								...
								e._w &&
									...
									(function(e) {
										...
										if (null != (t = e._w).GG || null != t.W || null != t.E)
											(a = 1),
												(s = 4),
												(n = Lt(t.GG, e._a[Me], qe(Wt(), 1, 4).year)),
												(o = Lt(t.W, 1)),
												((r = Lt(t.E, 1)) < 1 || r > 7) && (d = !0)
										else {
											;(a = e._locale._week.dow), (s = e._locale._week.doy)
											var u = qe(Wt(), a, s)
											;(n = Lt(t.gg, e._a[Me], u.year)),
												(o = Lt(t.w, u.week)),
												null != t.d
													? ((r = t.d) < 0 || r > 6) && (d = !0)
													: null != t.e
													? ((r = t.e + a), (t.e < 0 || t.e > 6) && (d = !0))
													: (r = a)
										}
										o < 1 || o > Ke(n, a, s)
											...
											: ((i = $e(n, o, r, a, s)), (e._a[Me] = i.year), (e._dayOfYear = i.dayOfYear))
									})(e),
								null != e._dayOfYear &&
									((s = Lt(e._a[Me], o[Me])),
						...
						24 === e._a[be] &&
							...
							(e._d = (e._useUTC ? Ge : Ue).apply(null, i)),
				...
				function gt(e) {
					...
					if (d) {
						...
						if (d[4]) {
							if (!St.exec(d[4])) return void (e._isValid = !1)
							s = 'Z'
						}
						;(e._f = r + (a || '') + (s || '')), Ot(e)
					} else e._isValid = !1
				...
				function xt(e) {
					...
					if (d) {
						var u =
							...
							(a = d[6]),
							(s = d[7]),
							(i = [jt(t), Fe.indexOf(n), parseInt(o, 10), parseInt(r, 10), parseInt(a, 10)]),
							s && i.push(parseInt(s, 10)),
							i)
						if (
							!(function(e, t, n) {
								return (
					...
					if (e._f !== r.ISO_8601)
						if (e._f !== r.RFC_2822) {
							...
							var t,
								...
								d = i.length,
								u = 0
							for (o = $(e._f, e._locale).match(J) || [], t = 0; t < o.length; t++)
								(a = o[t]),
									(n = (i.match(le(a, e)) || [])[0]) &&
										...
										(u += n.length)),
									U[a]
										? (n ? (f(e).empty = !1) : f(e).unusedTokens.push(a), he(a, n, e))
										: e._strict && !n && f(e).unusedTokens.push(a)
							;(f(e).charsLeftOver = d - u),
								i.length > 0 && f(e).unusedInput.push(i),
								e._a[be] <= 12 && !0 === f(e).bigHour && e._a[be] > 0 && (f(e).bigHour = void 0),
				...
				function Et(e, t, n, o, r) {
					...
					return (
						...
						(d._f = t),
						(d._strict = o),
						(s = new b(Mt(Pt(d))))._nextDay && (s.add(1, 'd'), (s._nextDay = void 0)),
						s
					)
				}
				function Wt(e, t, n, o) {
				...
				function Nt(e) {
					...
					;(this._isValid = (function(e) {
						for (var t in e) if (-1 === je.call(zt, t) || (null != e[t] && isNaN(e[t]))) return !1
						for (var n = !1, o = 0; o < zt.length; ++o)
							if (e[zt[o]]) {
								if (n) return !1
								parseFloat(e[zt[o]]) !== v(e[zt[o]]) && (n = !0)
							}
						return !0
					})(t)),
						(this._milliseconds = +_ + 1e3 * u + 6e4 * d + 1e3 * i * 60 * 60),
						(this._days = +s + 7 * a),
				...
				It('Z', ':'),
					...
					fe(['Z', 'ZZ'], function(e, t, n) {
						;(n._useUTC = !0), (n._tzm = Gt(de, e))
					})
				var Ut = /([\+\-]|\d\d)/gi
				function Gt(e, t) {
					var n = (t || '').match(e)
					if (null === n) return null
					var o = ((n[n.length - 1] || []) + '').match(Ut) || ['-', 0, 0],
						r = 60 * o[1] + v(o[2])
				...
				function Vt(e, t) {
					...
					return t._isUTC
						? ((n = t.clone()),
						  (o = (k(e) || _(e) ? e.valueOf() : Wt(e).valueOf()) - n.valueOf()),
							  ...
							  (r =
									a.isValid() && i.isValid()
										? ((i = Vt(i, a)),
										  a.isBefore(i)
												? (d = Xt(a, i))
												: (((d = Xt(i, a)).milliseconds = -d.milliseconds), (d.months = -d.months)),
										  d)
										: { milliseconds: 0, months: 0 }),
							  ((_ = {}).ms = r.milliseconds),
							  (_.M = r.months)),
						(o = new Nt(_)),
						Jt(e) && l(e, '_locale') && (o._locale = e._locale),
						o
					)
				}
				function Qt(e, t) {
					...
					return function(n, o) {
						...
						return (
							null === o ||
								...
								(n = o),
								(o = r)),
							tn(this, Zt((n = 'string' == typeof n ? +n : n), o), e),
							this
						)
					}
				}
				function tn(e, t, n, o) {
					...
					e.isValid() &&
						((o = null == o || o),
						i && ze(e, Oe(e, 'Month') + i * n),
						s && Pe(e, 'Date', Oe(e, 'Date') + s * n),
						a && e._d.setTime(e._d.valueOf() + a * n),
						o && r.updateOffset(e, s || i))
				}
				;(Zt.fn = Nt.prototype),
					(Zt.invalid = function() {
						return Zt(NaN)
				...
				function hn(e, t, n, o, r) {
					...
					return null == e
						? qe(this, o, r).year
						: (t > (a = Ke(e, o, r)) && (t = a), Mn.call(this, e, t, n, o, r))
				}
				...
				G(0, ['gg', 2], 0, function() {
					...
					me('GGGGG', re, Q),
					me('ggggg', re, Q),
					pe(['gggg', 'ggggg', 'GGGG', 'GGGGG'], function(e, t, n, o) {
						t[o.substr(0, 2)] = v(e)
					}),
				...
				;(Dn.add = nn),
					...
					(Dn.diff = function(e, t, n) {
						...
						if (!(o = Vt(e, this)).isValid()) return NaN
						switch (((r = 6e4 * (o.utcOffset() - this.utcOffset())), (t = A(t)))) {
							case 'year':
								a = rn(this, o) / 12
								break
							case 'month':
					...
					(Dn.endOf = function(e) {
						...
						switch (e) {
							...
							case 'hour':
								;(t = this._d.valueOf()),
									(t += mn - cn(t + (this._isUTC ? 0 : this.utcOffset() * _n), mn) - 1)
								break
							case 'minute':
					...
					(Dn.startOf = function(e) {
						...
						switch (e) {
							...
							case 'hour':
								;(t = this._d.valueOf()),
									(t -= cn(t + (this._isUTC ? 0 : this.utcOffset() * _n), mn))
								break
							case 'minute':
					...
					(Dn.utcOffset = function(e, t, n) {
						...
						if (null != e) {
							if ('string' == typeof e) {
								if (null === (e = Gt(de, e))) return this
							} else Math.abs(e) < 16 && !n && (e *= 60)
							return (
								!this._isUTC && t && (o = $t(this)),
								(this._offset = e),
								(this._isUTC = !0),
								null != o && this.add(o, 'm'),
								a !== e &&
									(!t || this._changeInProgress
										? tn(this, Zt(e - a, 'm'), 1, !1)
					...
					(Dn.local = function(e) {
						return (
							this._isUTC &&
								(this.utcOffset(0, e), (this._isUTC = !1), e && this.subtract($t(this), 'm')),
							this
						)
					}),
					...
					(Dn.dates = g('dates accessor is deprecated. Use date instead.', Ln)),
					(Dn.months = g('months accessor is deprecated. Use month instead', Ne)),
					(Dn.years = g('years accessor is deprecated. Use year instead', He)),
					(Dn.zone = g(
					...
					(Dn.isDSTShifted = g(
						...
						function() {
							...
							var e = {}
							if ((L(e, this), (e = Pt(e))._a)) {
								var t = e._isUTC ? y(e._a) : Wt(e._a)
				...
				function jn(e, t, n) {
					...
					var o,
						r = []
					for (o = 0; o < 12; o++) r[o] = wn(e, o, n, 'month')
					return r
				}
				function Hn(e, t, n, o) {
					'boolean' == typeof e
					...
					var r,
						a = ht(),
						s = e ? a._week.dow : 0
					if (null != n) return wn(t, (n + s) % 7, o, 'day')
					var i = []
					for (r = 0; r < 7; r++) i[r] = wn(t, (r + s) % 7, o, 'day')
					return i
				}
				;(gn.calendar = function(e, t, n) {
					...
					(gn.preparse = Tn),
					(gn.postformat = Tn),
					(gn.relativeTime = function(e, t, n, o) {
						var r = this._relativeTime[n]
						return x(r) ? r(e, t, n, o) : r.replace(/%d/i, e)
					}),
					...
					(gn.monthsRegex = function(e) {
						return this._monthsParseExact
							? (l(this, '_monthsRegex') || Ie.call(this),
					...
					(gn.monthsShortRegex = function(e) {
						return this._monthsParseExact
							...
							: (l(this, '_monthsShortRegex') || (this._monthsShortRegex = Je),
					...
					(gn.weekdaysRegex = function(e) {
						return this._weekdaysParseExact
							? (l(this, '_weekdaysRegex') || rt.call(this),
							  e ? this._weekdaysStrictRegex : this._weekdaysRegex)
							: (l(this, '_weekdaysRegex') || (this._weekdaysRegex = tt),
					...
					(gn.weekdaysMinRegex = function(e) {
						return this._weekdaysParseExact
							...
							: (l(this, '_weekdaysMinRegex') || (this._weekdaysMinRegex = ot),
					...
					(r.lang = g('moment.lang is deprecated. Use moment.locale instead.', ft)),
					(r.langData = g('moment.langData is deprecated. Use moment.localeData instead.', ht))
				var xn = Math.abs
				function On(e, t, n, o) {
					var r = Zt(t, n)
					return (
				...
				function ao() {
					...
					if (!m) return 'P0D'
					var l = m < 0 ? '-' : '',
						c = ro(this._months) !== ro(m) ? '-' : '',
						y = ro(this._days) !== ro(m) ? '-' : '',
						f = ro(this._milliseconds) !== ro(m) ? '-' : ''
					return (
						l +
						'P' +
						(a ? c + a + 'Y' : '') +
							...
							n = (function(e, t, n) {
								var o = Zt(e).abs(),
									...
									_ = (r <= to.ss && ['s', r]) ||
										...
										(d < to.M && ['MM', d]) ||
										(u <= 1 && ['y']) || ['yy', u]
								return (_[2] = t), (_[3] = +e > 0), (_[4] = n), no.apply(null, _)
							})(this, !e, t)
					...
					(r.updateLocale = function(e, t) {
						if (null != t) {
							var n,
								o,
								r = _t
							null != (o = yt(e)) && (r = o._config),
								((n = new P((t = O(r, t)))).parentLocale = mt[e]),
								(mt[e] = n),
								ft(e)
						} else
							null != mt[e] &&
								(null != mt[e].parentLocale
									? (mt[e] = mt[e].parentLocale)
									: null != mt[e] && delete mt[e])
						return mt[e]
					}),
					(r.locales = function() {
						return w(mt)
				...
				'object' === s(t) && void 0 !== e
					? (e.exports = a())
					: void 0 === (r = 'function' == typeof (o = a) ? o.call(t, n, t, e) : o) ||
					  (e.exports = r)
		}.call(this, n(74)(e)))
	},
	,
	...
	function(e, t, n) {
		'use strict'
		e.exports = function(e, t, n, o, r, a, s, i) {
			if (!e) {
				var d
				if (void 0 === t)
					d = new Error(
	...
	function(e, t, n) {
		...
		i[o.ForwardRef] = { $$typeof: !0, render: !0, defaultProps: !0, displayName: !0, propTypes: !0 }
		...
		e.exports = function e(t, n, o) {
			if ('string' != typeof n) {
				...
				var s = _(n)
				m && (s = s.concat(m(n)))
				for (var i = d(t), f = d(n), p = 0; p < s.length; ++p) {
					var h = s[p]
					if (!(a[h] || (o && o[h]) || (f && f[h]) || (i && i[h]))) {
						var M = l(n, h)
						try {
							u(t, h, M)
						} catch (e) {}
	...
	function(e, t, n) {
		...
		function d(e, t, n) {
			...
			function h(e) {
				...
				for (var t = (m = l), n = 0; n < t.length; n++) {
					;(0, t[n])()
				}
				return e
			}
		...
		function p() {
			...
			return function(e) {
				return function() {
					...
					return y({}, n, { dispatch: (o = f.apply(void 0, a)(n.dispatch)) })
				}
			}
		}
	},
					...
					0 !== e.userId
						? r.createElement(
								...
								r.createElement(
									...
									{
										className:
											'repository--nav--current-user--menu ' + (i ? 'is-open' : 'is-not-open')
									},
									r.createElement(
										'div',
	...
	function(e, t, n) {
		...
		function M(e, t) {
			...
			p()('store' === b, 'storeKey has been removed and does not do anything. ' + j)
			var H = g
			return function(t) {
				...
				var c = (function(n) {
					function r(t) {
						...
						return (
							...
							(o.selectChildElement = function(e, t, n) {
								return (
									(t === c && n === y && h === e) ||
										((c = t), (y = n), (h = e), (f = a.a.createElement(e, m({}, t, { ref: n })))),
									f
								)
							}),
					...
					var i = r.prototype
					return (
						(i.indirectRenderWrappedComponent = function(e) {
						...
						(i.renderWrappedComponent = function(e) {
							...
							var n,
								...
								r = e.store,
								a = this.props
							D && ((a = this.props.wrapperProps), (n = this.props.forwardedRef))
							var i = this.selectDerivedProps(o, a, r, d)
							return this.selectChildElement(t, i, n)
						}),
						(i.render = function() {
							var e =
								this.props.context &&
								this.props.context.Consumer &&
								Object(h.isContextConsumer)(a.a.createElement(this.props.context.Consumer, null))
									? this.props.context
									: H
				...
				if (((c.WrappedComponent = t), (c.displayName = s), D)) {
					var M = a.a.forwardRef(function(e, t) {
						return a.a.createElement(c, { wrapperProps: e, forwardedRef: t })
					})
					return (M.displayName = s), (M.WrappedComponent = t), y()(M, t)
				}
				return y()(c, t)
			}
		}
		...
		function k(e, t) {
			...
			for (var r = 0; r < n.length; r++) if (!Y.call(t, n[r]) || !b(e[n[r]], t[n[r]])) return !1
			return !0
		}
		var S = n(42)
		function v(e) {
			...
			return function(t, n) {
				...
				return (
					...
					(o.mapToProps = function(t, n) {
						...
						return (
							'function' == typeof r &&
								((o.mapToProps = r), (o.dependsOnOwnProps = D(r)), (r = o(t, n))),
							r
						)
					}),
					o
					...
					? (function(e) {
							return function(t, n) {
								...
								return function(t, n, i) {
									var d = e(t, n, i)
									return s ? (r && a(d, o)) || (o = d) : ((s = !0), (o = d)), o
								}
							}
					  })(e)
					: void 0
		...
		function P(e, t, n, o, r) {
			...
			function y(r, c) {
				...
				return (
					...
					(s = c),
					p && h
						? ((i = e(a, s)), t.dependsOnOwnProps && (d = t(o, s)), (u = n(i, d, s)))
						: p
						? (e.dependsOnOwnProps && (i = e(a, s)),
						  t.dependsOnOwnProps && (d = t(o, s)),
						  (u = n(i, d, s)))
						: h
						? ((y = e(a, s)), (f = !l(y, i)), (i = y), f && (u = n(i, d, s)), u)
						: u
				)
			}
			return function(r, _) {
				return c
					? y(r, _)
					: ((i = e((a = r), (s = _))), (d = t(o, s)), (u = n(i, d, s)), (c = !0), u)
			}
		}
		function E(e, t) {
			var n = t.initMapStateToProps,
				...
				r = t.initMergeProps,
				a = l(t, ['initMapStateToProps', 'initMapDispatchToProps', 'initMergeProps']),
				s = n(e, a),
				i = o(e, a),
				d = r(e, a)
			return (a.pure ? P : O)(s, i, d, e, a)
		}
		function W(e) {
			return (W =
				'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
		...
		var C,
			...
			K,
			B =
				((N = (z = void 0 === C ? {} : C).connectHOC),
				(J = void 0 === N ? M : N),
				(R = z.mapStateToPropsFactories),
				(I = void 0 === R ? j : R),
				(U = z.mapDispatchToPropsFactories),
				(G = void 0 === U ? w : U),
				(V = z.mergePropsFactories),
				($ = void 0 === V ? x : V),
				(q = z.selectorFactory),
				(K = void 0 === q ? E : q),
				function(e, t, n, o) {
					...
					var r = o,
						...
						M = A(e, I, 'mapStateToProps'),
						L = A(t, G, 'mapDispatchToProps'),
						Y = A(n, $, 'mergeProps')
					return J(
						K,
						m(
	...
	function(e, t, n) {
		...
		var r = 'function' == typeof Symbol && Symbol.for,
			...
			_ = r ? Symbol.for('react.provider') : 60109,
		...
		e.exports = {
			hydrateEl: function(e, t, n) {
				var o = document.querySelector(n),
					r = _(e, u(t, JSON.parse(o.dataset.reactProps)))
				ReactDOM.hydrate(r, o)
			},
			hydrateElWithoutStore: function(e, t) {
				var n = document.querySelector(t),
					r = JSON.parse(n.dataset.reactProps),
					a = o.createElement(e, r)
				ReactDOM.hydrate(a, n)
			},
			propsToStore: u,
			createCommonReactApp: _,
								...
								return (
									e({
										...
										meta: r(
											...
											l,
											((o = {}),
											d(o, i.KEY.LIFECYCLE, i.LIFECYCLE.START),
											d(o, i.KEY.TRANSACTION, c),
											o)
										)
									}),
									u(l, 'onStart', m, t),
											...
											return (
												e({
													...
													meta: r(
														...
														l,
														((o = { startPayload: y }),
														d(o, i.KEY.LIFECYCLE, i.LIFECYCLE.SUCCESS),
														d(o, i.KEY.TRANSACTION, c),
														o)
													)
												}),
											...
											return (
												e({
													...
													meta: r(
														...
														l,
														((o = { startPayload: y }),
														d(o, i.KEY.LIFECYCLE, i.LIFECYCLE.FAILURE),
														d(o, i.KEY.TRANSACTION, c),
														o)
													)
												}),
	...
	function(e, t, n) {
		...
		e.exports = function(e, t, n) {
			...
			if (null == m || null == l) {
				var c = a()
				null == m && (m = o = [1 | c[0], c[1], c[2], c[3], c[4], c[5]]),
			...
			var y = void 0 !== e.msecs ? e.msecs : new Date().getTime(),
				...
				p = y - i + (f - d) / 1e4
			if (
				(p < 0 && void 0 === e.clockseq && (l = (l + 1) & 16383),
				(p < 0 || y > i) && void 0 === e.nsecs && (f = 0),
				f >= 1e4)
			)
				throw new Error("uuid.v1(): Can't create more than 10M uuids/sec")
			;(i = y), (d = f), (r = l)
			var h = (1e4 * (268435455 & (y += 122192928e5)) + f) % 4294967296
			;(_[u++] = (h >>> 24) & 255),
				(_[u++] = (h >>> 16) & 255),
				(_[u++] = (h >>> 8) & 255),
				(_[u++] = 255 & h)
	...
	function(e, t, n) {
		...
		function l(e, t, n, s) {
			switch (o(t)) {
				case 'function':
					var u = t(e, n)
					return (0, d.default)(void 0 !== u, (0, i.default)(r, s, n.type)), u
				case 'undefined':
					return e
				default:
					return (0, d.default)(!1, (0, i.default)(a, s, n.type, o(t))), e
			}
		}
		e.exports = function(e, t, n) {
			var o = t.meta,
				r = o ? o[u.KEY.LIFECYCLE] : null
			if (null == r) return (0, d.default)(!1, (0, i.default)(s, t.type)), e
			var a = e
			switch (r) {
				case u.LIFECYCLE.START:
					a = l(a, n.start, t, 'start')
					break
				case u.LIFECYCLE.SUCCESS:
					;(a = l(a, n.success, t, 'success')), (a = l(a, n.finish, t, 'finish'))
					break
				case u.LIFECYCLE.FAILURE:
					;(a = l(a, n.failure, t, 'failure')), (a = l(a, n.finish, t, 'finish'))
			}
			return (a = l(a, n.always, t, 'always'))
		}
	},
	function(e, t) {
		e.exports = function(e) {
	...
	function(e, t, n) {
		...
		;(s = function(e) {
			...
			'object' === i(t) && void 0 !== e
				? s(n(2))
				: ((r = [n(2)]),
				  void 0 === (a = 'function' == typeof (o = s) ? o.apply(t, r) : o) || (e.exports = a))
	},
	function(e, t, n) {
		var o, r, a, s
		function i(e) {
		...
		;(s = function(e) {
			...
			return e.defineLocale('el', {
				...
				calendar: function(e, t) {
					var n,
						o = this._calendarEl[e],
						r = t && t.hours()
					return (
						((n = o) instanceof Function ||
		...
		;(s = function(e) {
			...
			function t(e, t, n) {
				...
				return (
					...
					e + o + { ss: 'secunde', mm: 'minute', hh: 'ore', dd: 'zile', MM: 'luni', yy: 'ani' }[n]
				)
			}
		...
		;(s = function(e) {
			...
			function r(e, t, n, r) {
				...
				switch (n) {
					...
					case 'ss':
						return t || r ? a + (o(e) ? 'sekundy' : 'sekúnd') : a + 'sekundami'
					case 'm':
						return t ? 'minúta' : r ? 'minútu' : 'minútou'
					case 'mm':
						return t || r ? a + (o(e) ? 'minúty' : 'minút') : a + 'minútami'
					case 'h':
						return t ? 'hodina' : r ? 'hodinu' : 'hodinou'
					case 'hh':
						return t || r ? a + (o(e) ? 'hodiny' : 'hodín') : a + 'hodinami'
					case 'd':
						return t || r ? 'deň' : 'dňom'
					case 'dd':
						return t || r ? a + (o(e) ? 'dni' : 'dní') : a + 'dňami'
					case 'M':
						return t || r ? 'mesiac' : 'mesiacom'
					case 'MM':
						return t || r ? a + (o(e) ? 'mesiace' : 'mesiacov') : a + 'mesiacmi'
					case 'y':
						return t || r ? 'rok' : 'rokom'
					case 'yy':
						return t || r ? a + (o(e) ? 'roky' : 'rokov') : a + 'rokmi'
				}
			}
	...
	function(e, t, n) {
		...
		e.exports = function(e) {
			return o.createElement(
				...
				o.createElement(a, { title: e.module.title }, o.createElement(s, { id: e.module.draftId })),
				o.createElement(
					'section',
					...
					o.createElement(
						i,
						{
							...
							onClick: function() {
								return u.copyModule(e.module.draftId)
							},
							disabled: !e.canCopy
						},
						'Copy this module'
					...
					o.createElement(
						...
						'Module created by',
						' ',
						o.createElement('b', null, e.owner.firstName, ' ', e.owner.lastName),
						' ',
						'on ',
						o.createElement('b', null, d(e.module.createdAt).format('ll')),
						' and updated',
						' ',
						d(e.module.updatedAt).fromNow(),
						'.'
					),
					o.createElement('h2', null, 'Use this Module in your Canvas Course'),
					o.createElement(
						'p',
						null,
						'This module can be used inside your course as an ',
						o.createElement('b', null, 'assignment'),
						' or ',
						o.createElement('b', null, 'module'),
						'.'
					),
					o.createElement(
						'figure',
						...
						o.createElement('figcaption', null, 'Creating an Assignment in Canvas')
					),
					o.createElement('h3', null, 'Create an Assignment in Canvas'),
					o.createElement(
						'ol',
						null,
						o.createElement('li', null, "Click Assignments in your course's menu."),
						o.createElement('li', null, 'Create a new Assignment'),
						o.createElement(
							'li',
							null,
							'Set the:',
							o.createElement(
								'ul',
								null,
								o.createElement('li', null, 'Assignment Name'),
								o.createElement('li', null, 'Points (do not use 0)'),
								o.createElement('li', null, 'any other relevant settings')
							)
						),
						o.createElement('li', null, 'Set Submission Type to "External Tool"'),
						o.createElement(
							'li',
							null,
							'Follow the ',
							o.createElement('a', { href: '#selecting-this-module' }, 'Choosing a Obojobo Module'),
							' instructions below'
						),
						o.createElement('li', null, 'Click Select'),
						o.createElement('li', null, 'Save & Publish')
					),
					o.createElement('h3', null, 'Create an Ungraded Module in Canvas'),
					o.createElement(
						'ol',
						null,
						o.createElement('li', null, "Click Modules in your course's menu."),
						o.createElement('li', null, 'Click the "+" in a module'),
						o.createElement('li', null, 'Type an Assignment Name'),
						o.createElement(
							'li',
							null,
						...
						o.createElement('li', null, 'Click Add Item'),
						o.createElement(
							'li',
							null,
							'You new module will be named "',
							e.module.title,
							' (doesn\'t send scores to grade book)"'
						),
						o.createElement(
							'li',
							null,
							'Be sure to ',
							o.createElement('b', null, 'Publish'),
							' within Canvas when ready'
						)
					),
					o.createElement('h3', { id: 'selecting-this-module' }, 'Choosing a Obojobo Module'),
					o.createElement(
						'ol',
						null,
						o.createElement('li', null, 'Follow one of the sets of instructions above.'),
						o.createElement(
							'li',
							null,
							'Click "FIND" next to the input labeled "Enter or find an External Tool URL"'
						),
						o.createElement(
							'li',
							null,
							'In the popup that appears, scroll down and select "ObojoboNext Module (gradebook synced)"'
						),
						o.createElement('li', null, 'Choose Community Collection'),
						o.createElement(
							'li',
							null,
							'Search for the module by its title (',
							o.createElement('code', null, e.module.title),
							') or its id (',
							o.createElement('code', null, e.module.draftId),
							')'
						),
						o.createElement('li', null, 'Click Embed next to your chosen module')
					)
				)
			)
		}
	...
	function(e, t, n) {
		...
		var o = n(119),
			r = n(412),
			a = n.n(r)
		Object(o.hydrateElWithoutStore)(a.a, '#react-hydrate-root')
	},
	function(e, t, n) {},
	function(e, t, n) {
		var o = {
		...
		var o = n(13),
			r = {
				copyModule: function(e) {
					return o.post('/api/drafts/'.concat(e, '/copy')).then(function(e) {
						200 === e.status
							? (window.location = '/dashboard')
							: 401 === e.status
							? window.alert('You are not authorized to copy this module')
							: window.alert('Something went wrong while copying')
					})
				}
			}
		e.exports = r
