...
module.exports = app => {
	...
	const oboNodesServer = getAllOboNodeScriptPathsByType('server')
	oboNodesServer.forEach(nodePath => {
		const nodeClass = require(nodePath)
		logger.info('Registering OboNode:', nodeClass.nodeName)
		draftNodeStore.add(nodeClass)
	})
