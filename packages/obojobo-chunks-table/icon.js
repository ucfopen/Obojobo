...
const Icon = () => {
	return (
		<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.5 14.75">
			<defs>
				<style>{`.table{opacity:0.55;}.line{fill:none;stroke:#231f20;stroke-miterlimit:10;}`}</style>
			</defs>
		<title>table</title>
			<g className="table">
